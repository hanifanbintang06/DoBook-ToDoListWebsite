...
import { Nut, CalendarBlank } from "@phosphor-icons/react";
import SideBarButton from "./SideBarButton";

export default function SideBar() {
    return(
        <div className="w-fit h-screen flex flex-col gap-4">
            <div className="w-68 h-full px-4 pt-4 pb-5 flex flex-col gap-5 bg-white rounded-2xl">
                <div className="w-auto h-fit py-3 flex flex-row gap-2 justify-center">
